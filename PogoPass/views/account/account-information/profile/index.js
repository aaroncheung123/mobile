...
import {View, Text, TouchableWithoutFeedback, TextInput, TouchableHighlight, ScrollView, WebView, Dimensions} from 'react-native';
        ...
        return (
					<View>
						...
						<View style={STYLES.container}>
							<WebView
								source = {{ uri: this.props.loginLink + '&url=https://www.pogopass.com/user/account/profile#user-profile' }}
							/>
						</View>
					</View>
